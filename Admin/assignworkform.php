  ...
  <form action="" method="POST">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" id="requesterzip" name="requesterzip" value="<?php if(isset($row['requester_zip'])) { echo $row['requester_zip']; } ?>" readonly
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <input type="text" class="form-control" id="requestermobile" name="requestermobile" value="<?php if(isset($row['requester_mobile'])) {echo $row['requester_mobile']; }?>" readonly
          onkeypress="isInputNumber(event)">
      </div>
    </div>
    <div class="form-row">
      ...
      <div class="form-group col-md-4  ">
        ...
        <select class=" form-control" id="assigntech" name="assigntech">
          ...
          <option value="Soikot">Soikot</option>
      ...
      <div class="form-group col-md-4">
        <label for="requestTech">Request Technician </label>
        <input type="text" class="form-control" id="requestTech" name="requestTech" value="<?php if(isset($row['requester_tech'])) { echo $row['requester_tech']; } ?>" readonly>
      </div>

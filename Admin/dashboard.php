...
session_start(); // jate login thake ta  new hole log in khuje new deice a 
 ...
 //total kaj ,tech egula akhane mention
...
<div class="col-sm-9 col-md-10">
  ...
  <div class="mx-5 mt-5 text-center">
    ...
    <?php
    $sql = "SELECT * FROM requesterlogin_tb"; //req  table  info gula call 
    $result = $conn->query($sql);

...
<body>
 <!-- Top Navbar -->
 <nav class="navbar navbar-dark fixed-top bg p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0 ml-5 py-2" href="dashboard.php"><img src="../images/customlogo.png"  style='width:120px;'alt=""></a>
 </nav>
   ...
   <nav class="col-sm-3 col-md-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      <li class="nav-item">
       <a class="nav-link bgColor <?php if(PAGE == 'dashboard') { echo 'active'; } ?> " href="dashboard.php">

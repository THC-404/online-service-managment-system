...
if(!isset($_SESSION['is_login'])){
  if(isset($_REQUEST['rEmail'])){
    ...
    if($result->num_rows == 1){
      ...
      $msg = '<div class="alert alert-warning mt-2 text-center" role="alert"> Enter Valid Email and Password </div>';
    }
  }
} else {
  echo "<script> location.href='RequesterProfile.php'; </script>";
...
<body>
  ...
  <img src="../images/customlogo.png" style='width: 200px;' alt="">
    <!--<span>Online Service Managment System</span> -->
  </div>
  <p class="text-center" style="font-size: 20px;">  <span>

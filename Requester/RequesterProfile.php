...
if (isset($_REQUEST['nameupdate'])) {
  if (($_REQUEST['rName'] == "")) {
    ...
    if ($conn->query($sql) == TRUE) {
      ...
      $passmsg = '<div class="alert alert-success col-sm-6 ml-5 mt-2 text-center" role="alert"> Updated Successfully </div>';
    } else {
      // below msg display on form submit failed
      $passmsg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2 text-center" role="alert"> Unable to Update </div>';
    }
  }
}
?>

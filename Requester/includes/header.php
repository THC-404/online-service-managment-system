...
<body>
 <!-- Top Navbar -->
 <nav class="navbar navbar-dark fixed-top bg flex-md-nowrap p-0 shadow">
 <a class="navbar-brand col-sm-3 col-md-2 mr-0 ml-5 py-2" href="RequesterProfile.php"><img src="../images/customlogo.png"  style='width:120px;'alt=""></a>
 </nav>

    ...
    if(($_REQUEST['rName'] == "") || ($_REQUEST['rEmail'] == "") || ($_REQUEST['rPassword'] == "")){
      ...
      if($result->num_rows == 1){
        ...
        if($conn->query($sql) == TRUE){
          $regmsg = '<div class="alert alert-success mt-2 text-center"  role="alert"> Account Succefully Created </div>';
        } else {
...
?>
<div class=" " style="background-image: url(images/White.jpg);" >
<div class="container pt-5 " id="registration" style="padding-top: 50px; padding-bottom: 100px;"  >
  <h2 class="text-center mt-5">Create an Account</h2>
  <div class="row mt-4 mb-4">
    <div class="col-md-6 offset-md-3 bg-white">
      <form action="" class="shadow-rg rounded p-4" method="POST">

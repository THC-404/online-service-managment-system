                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body " data-aos="zoom-in">
                                ...
                                <h5 class="text-center">Umma Saima Rahman</h5> 
                                 <p class="text-center">   Lecturer,<br>
                                    Department of Computer Science & Engineering<br>
                                    Port City International University<br>
                                </p>

                                <h2 class="text-center"> <span class="font-weight-bold">Project title:</span> Online Service Managment System</h2>
                                <p class="text-center">Presented by</p>
                                <p class="text-center">
                                Taufiqul Hoque Chy (CSE 02106999)<br>
                                S.M. Mazharul Islam Rifat (CSE 02106984)<br>
                                Gazi Saiful Mahmud (CSE 02006957)<br>

                                </p>
                                <div class="date justify-content-end">
                                    <h6 class="text-center"> <span class="font-weight-bold">Date : </span> 03 April 2022
                                    </h6>
                                </div>
